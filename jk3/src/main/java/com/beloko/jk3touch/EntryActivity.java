...
import static com.beloko.jk3.R.layout;
import static com.beloko.jk3.R.raw;
...
public class EntryActivity extends FragmentActivity  {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(layout.activity_quake);
		...
		com.beloko.touchcontrols.GamePadFragment.gamepadActions = Utils.getGameGamepadConfig(com.beloko.opengames.AppSettings.game);
		...
		if (AboutDialog.showAbout(this))
			AboutDialog.show(this, raw.changes, raw.about);
