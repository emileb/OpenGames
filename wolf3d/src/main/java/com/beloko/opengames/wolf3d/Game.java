 ...
 */
package com.beloko.opengames.wolf3d;
...
public class Game extends Activity 
{
	...
	class QuakeRenderer implements MyGLSurfaceView.Renderer {
		...
		private void init( int width, int height ){
			...
			int disableAplhaFix =  getIntent().getIntExtra("disable_alpha_fix", 0);
			
			int ret = NativeLib.init(AppSettings.graphicsDir,disableAplhaFix,args_array,lowRes,gamePath);
