...
public class EntryActivity extends FragmentActivity  {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		{
			IntroDialog.show(this,"RTCW Touch",R.raw.intro);
		}
		else
		{
			if (com.beloko.opengames.AboutDialog.showAbout(this))
				com.beloko.opengames.AboutDialog.show(this, R.raw.changes, R.raw.about);
		}
