...
/*******************************************************************************
                 Extra Android function for app
*******************************************************************************/
static bool doSwapBuffer = true;
...
{
	LOGI("Android_JNI_ShowTextInput");
...
void Java_com_beloko_libsdl_SDLLib_nativeInit(JNIEnv* env, jclass cls, jobject obj)
{
...
// Resize
void Java_com_beloko_libsdl_SDLLib_onNativeResize(
                                    JNIEnv* env, jclass jcls,
                                    jint width, jint height, jint format)
{
...
// Keydown
void Java_com_beloko_libsdl_SDLLib_onNativeKeyDown(
                                    JNIEnv* env, jclass jcls, jint keycode)
{
...
// Keyup
void Java_com_beloko_libsdl_SDLLib_onNativeKeyUp(
                                    JNIEnv* env, jclass jcls, jint keycode)
{
