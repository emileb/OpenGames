...
int Android_ScreenWidth_Actual,Android_ScreenHeight_Actual;
...
Android_SetScreenResolution(int width, int height, Uint32 format)
{
    ...
    Android_ScreenWidth_Actual = width;
    Android_ScreenHeight_Actual = height;
    //Overrise by Emile
    Android_ScreenWidth = 320;
    Android_ScreenHeight = 200;
