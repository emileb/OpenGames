...
char *va_NETWORK(ch'ar *buf, size_t buflen, const char *format, ...) DP_FUNC_PRINTF(3);
...
extern int dpvsnprintf_NETWORK (char *buffer, size_t buffersize, const char *format, va_list args);
