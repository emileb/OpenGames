...
static textypeinfo_t textype_colorbuffer16f              = {"colorbuffer16f",             TEXTYPE_COLORBUFFER16F       ,  4,  4,  4.0f, GL_RGBA                             , GL_RGBA           , GL_UNSIGNED_BYTE};
static textypeinfo_t textype_colorbuffer32f              = {"colorbuffer32f",             TEXTYPE_COLORBUFFER32F       ,  4,  4,  4.0f, GL_RGBA                             , GL_RGBA           , GL_UNSIGNED_BYTE};
...
#endif
	default:
		Host_Error("R_GetTexTypeInfo: unknown texture format (%d)",textype);
		break;
	}
	return NULL;
}
