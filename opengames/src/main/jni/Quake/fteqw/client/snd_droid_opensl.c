...
JNIEXPORT jint JNICALL Java_com_beloko_opengames_fteqw_FTEDroidEngine_audioinfo(JNIEnv *env, jclass this, jint arg)
{
...
JNIEXPORT jint JNICALL Java_com_beloko_opengames_fteqw_FTEDroidEngine_paintaudio(JNIEnv *env, jclass this, jbyteArray stream, jint len)
{
	int offset = 0;
	soundcardinfo_t *sc = sys_sc;
	int framesz;
...
{
	//fixme: what if we're currently inside Java_com_beloko_idtech_fteqw_FTEDroidEngine_paintaudio?
	sys_sc = NULL;
	free(sc->sn.buffer);
	sys_soundflags = 0;
}
