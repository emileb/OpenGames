...
#define JAVA_FUNC(x) Java_com_beloko_opengames_jk2_NativeLib_##x
...
void initControls(int width, int height,const char * graphics_path,const char *settings_file)
{
	...
	if (!controlsCreated)
	{
		...
		tcInventory->addControl(new touchcontrols::Button("invprev",touchcontrols::RectF(5,14,7,16),"arrow_left",PORT_ACT_INVPREV));
		tcInventory->addControl(new touchcontrols::Button("invnext",touchcontrols::RectF(7,14,9,16),"arrow_right",PORT_ACT_INVNEXT));
		...
		//Force Select
		tcForceSelect->addControl(new touchcontrols::Button("force_pull",touchcontrols::RectF(4,4,7,7),"force_pull",PORT_ACT_FORCE_PULL));
		tcForceSelect->addControl(new touchcontrols::Button("force_speed",touchcontrols::RectF(4,7,7,10),"force_speed",PORT_ACT_FORCE_SPEED));
		tcForceSelect->addControl(new touchcontrols::Button("force_push",touchcontrols::RectF(4,10,7,13),"force_push",PORT_ACT_FORCE_PUSH));
		tcForceSelect->addControl(new touchcontrols::Button("force_grip",touchcontrols::RectF(7,4,10,7),"force_grip",PORT_ACT_FORCE_GRIP));
		tcForceSelect->addControl(new touchcontrols::Button("force_heal",touchcontrols::RectF(7,7,10,10),"force_heal",PORT_ACT_FORCE_HEAL));
		tcForceSelect->addControl(new touchcontrols::Button("force_mind",touchcontrols::RectF(7,10,10,13),"force_mind",PORT_ACT_FORCE_MIND));
		tcForceSelect->addControl(new touchcontrols::Button("force_lightning",touchcontrols::RectF(1,10,4,13),"force_lightning",PORT_ACT_FORCE_LIGHT));
...
#ifdef ANTI_HACK
	if (crcCheck((lib_path + "/libjk2.so").c_str()))
        return;
#endif
