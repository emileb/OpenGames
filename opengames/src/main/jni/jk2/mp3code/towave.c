...
//// this code should never be executed now, since music can legally be stereo, and FX will be unpacked as mono anyway
//#ifdef REJECT_STEREO_MP3s
//		if (decinfo.channels == 2)
//		{
//			return "MP3ERR: Source file is stereo!";
//		}
//#endif
