...
extern "C" {
#endif
int  __attribute__((visibility("default"))) vmMain( int command, int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7 ) {
	centity_t		*cent;
...
void CG_SelectForcePower_f( void )
{
	char * targetname = (char	*)CG_Argv(1);

	int sel = atoi(targetname);

	LOGI("CG_SelectForcePower_f %s",targetname);
