...
LOGI("glcongg = %p",&glConfig);
	...
	LOGI("glcongg 1 = %p",&glConfig);

	LOGI("r_smp 1 = %p",glConfig);
...
//	r_smp = ri.Cvar_Get( "r_smp", "0", CVAR_ARCHIVE | CVAR_LATCH);
	...
	r_znear = ri.Cvar_Get( "r_znear", "5", CVAR_CHEAT );	//if set any lower, you lose a lot of precision in the distance
	...
	r_primitives = ri.Cvar_Get( "r_primitives", "2", CVAR_CHEAT );
