...
void WriteLevelLocals ()
{
	...
	level_locals_t *temp = new level_locals_t[1];
...
void ReadLevelLocals ()
{
	...
	level_locals_t *temp = new level_locals_t[1]; //Need this coz Android stack is too small
	memcpy(temp,&level,sizeof(level));
