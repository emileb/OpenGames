...
void qgl_printf (char *fmt, ...)
{
	...
	__android_log_vprint(ANDROID_LOG_DEBUG, "QGL", fmt, argptr);
...
static void QGL_not_implemented_func(char *name)
{
	Com_Printf ("QGL : %s not implemented", name);
	exit(1);
}

#if 0
#define QGL_NOT_IMPLEMENTED(func,print) { func = (void*)print; };
#define PRINT_ERROR(name,func) static void func() { QGL_not_implemented_func(name); }
#else
#define QGL_NOT_IMPLEMENTED(func,print) { func = (void*)QGL_not_implemented; };
#define PRINT_ERROR(name,func)
#endif

PRINT_ERROR("nanoAccum",print_Accum);
PRINT_ERROR("nanoAlphaFunc",print_AlphaFunc);
PRINT_ERROR("nanoAreTexturesResident",print_AreTexturesResident);
PRINT_ERROR("nanoArrayElement",print_ArrayElement);
PRINT_ERROR("nanoBegin",print_Begin);
PRINT_ERROR("nanoBindTexture",print_BindTexture);
PRINT_ERROR("nanoBitmap",print_Bitmap);
PRINT_ERROR("nanoBlendFunc",print_BlendFunc);
PRINT_ERROR("nanoCallList",print_CallList);
PRINT_ERROR("nanoCallLists",print_CallLists);
PRINT_ERROR("nanoClear",print_Clear);
PRINT_ERROR("nanoClearAccum",print_ClearAccum);
PRINT_ERROR("nanoClearColor",print_ClearColor);
PRINT_ERROR("nanoClearDepth",print_ClearDepth);
PRINT_ERROR("nanoClearIndex",print_ClearIndex);
PRINT_ERROR("nanoClearStencil",print_ClearStencil);
PRINT_ERROR("nanoClipPlane",print_ClipPlane);
PRINT_ERROR("nanoColor3b",print_Color3b);
PRINT_ERROR("nanoColor3bv",print_Color3bv);
PRINT_ERROR("nanoColor3d",print_Color3d);
PRINT_ERROR("nanoColor3dv",print_Color3dv);
PRINT_ERROR("nanoColor3f",print_Color3f);
PRINT_ERROR("nanoColor3fv",print_Color3fv);
PRINT_ERROR("nanoColor3i",print_Color3i);
PRINT_ERROR("nanoColor3iv",print_Color3iv);
PRINT_ERROR("nanoColor3s",print_Color3s);
PRINT_ERROR("nanoColor3sv",print_Color3sv);
PRINT_ERROR("nanoColor3ub",print_Color3ub);
PRINT_ERROR("nanoColor3ubv",print_Color3ubv);
PRINT_ERROR("nanoColor3ui",print_Color3ui);
PRINT_ERROR("nanoColor3uiv",print_Color3uiv);
PRINT_ERROR("nanoColor3us",print_Color3us);
PRINT_ERROR("nanoColor3usv",print_Color3usv);
PRINT_ERROR("nanoColor4b",print_Color4b);
PRINT_ERROR("nanoColor4bv",print_Color4bv);
PRINT_ERROR("nanoColor4d",print_Color4d);
PRINT_ERROR("nanoColor4dv",print_Color4dv);
PRINT_ERROR("nanoColor4f",print_Color4f);
PRINT_ERROR("nanoColor4fv",print_Color4fv);
PRINT_ERROR("nanoColor4i",print_Color4i);
PRINT_ERROR("nanoColor4iv",print_Color4iv);
PRINT_ERROR("nanoColor4s",print_Color4s);
PRINT_ERROR("nanoColor4sv",print_Color4sv);
PRINT_ERROR("nanoColor4ub",print_Color4ub);
PRINT_ERROR("nanoColor4ubv",print_Color4ubv);
PRINT_ERROR("nanoColor4ui",print_Color4ui);
PRINT_ERROR("nanoColor4uiv",print_Color4uiv);
PRINT_ERROR("nanoColor4us",print_Color4us);
PRINT_ERROR("nanoColor4usv",print_Color4usv);
PRINT_ERROR("nanoColorMask",print_ColorMask);
PRINT_ERROR("nanoColorMaterial",print_ColorMaterial);
PRINT_ERROR("nanoColorPointer",print_ColorPointer);
PRINT_ERROR("nanoCopyPixels",print_CopyPixels);
PRINT_ERROR("nanoCopyTexImage1D",print_CopyTexImage1D);
PRINT_ERROR("nanoCopyTexImage2D",print_CopyTexImage2D);
PRINT_ERROR("nanoCopyTexSubImage1D",print_CopyTexSubImage1D);
PRINT_ERROR("nanoCopyTexSubImage2D",print_CopyTexSubImage2D);
PRINT_ERROR("nanoCullFace",print_CullFace);
PRINT_ERROR("nanoDeleteLists",print_DeleteLists);
PRINT_ERROR("nanoDeleteTextures",print_DeleteTextures);
PRINT_ERROR("nanoDepthFunc",print_DepthFunc);
PRINT_ERROR("nanoDepthMask",print_DepthMask);
PRINT_ERROR("nanoDepthRange",print_DepthRange);
PRINT_ERROR("nanoDisable",print_Disable);
PRINT_ERROR("nanoDisableClientState",print_DisableClientState);
PRINT_ERROR("nanoDrawArrays",print_DrawArrays);
PRINT_ERROR("nanoDrawBuffer",print_DrawBuffer);
PRINT_ERROR("nanoDrawElements",print_DrawElements);
PRINT_ERROR("nanoDrawPixels",print_DrawPixels);
PRINT_ERROR("nanoEdgeFlag",print_EdgeFlag);
PRINT_ERROR("nanoEdgeFlagPointer",print_EdgeFlagPointer);
PRINT_ERROR("nanoEdgeFlagv",print_EdgeFlagv);
PRINT_ERROR("nanoEnable",print_Enable);
PRINT_ERROR("nanoEnableClientState",print_EnableClientState);
PRINT_ERROR("nanoEnd",print_End);
PRINT_ERROR("nanoEndList",print_EndList);
PRINT_ERROR("nanoEvalCoord1d",print_EvalCoord1d);
PRINT_ERROR("nanoEvalCoord1dv",print_EvalCoord1dv);
PRINT_ERROR("nanoEvalCoord1f",print_EvalCoord1f);
PRINT_ERROR("nanoEvalCoord1fv",print_EvalCoord1fv);
PRINT_ERROR("nanoEvalCoord2d",print_EvalCoord2d);
PRINT_ERROR("nanoEvalCoord2dv",print_EvalCoord2dv);
PRINT_ERROR("nanoEvalCoord2f",print_EvalCoord2f);
PRINT_ERROR("nanoEvalCoord2fv",print_EvalCoord2fv);
PRINT_ERROR("nanoEvalMesh1",print_EvalMesh1);
PRINT_ERROR("nanoEvalMesh2",print_EvalMesh2);
PRINT_ERROR("nanoEvalPoint1",print_EvalPoint1);
PRINT_ERROR("nanoEvalPoint2",print_EvalPoint2);
PRINT_ERROR("nanoFeedbackBuffer",print_FeedbackBuffer);
PRINT_ERROR("nanoFinish",print_Finish);
PRINT_ERROR("nanoFlush",print_Flush);
PRINT_ERROR("nanoFogf",print_Fogf);
PRINT_ERROR("nanoFogfv",print_Fogfv);
PRINT_ERROR("nanoFogi",print_Fogi);
PRINT_ERROR("nanoFogiv",print_Fogiv);
PRINT_ERROR("nanoFrontFace",print_FrontFace);
PRINT_ERROR("nanoFrustum",print_Frustum);
PRINT_ERROR("nanoGenLists",print_GenLists);
PRINT_ERROR("nanoGenTextures",print_GenTextures);
PRINT_ERROR("nanoGetBooleanv",print_GetBooleanv);
PRINT_ERROR("nanoGetClipPlane",print_GetClipPlane);
PRINT_ERROR("nanoGetDoublev",print_GetDoublev);
PRINT_ERROR("nanoGetError",print_GetError);
PRINT_ERROR("nanoGetFloatv",print_GetFloatv);
PRINT_ERROR("nanoGetIntegerv",print_GetIntegerv);
PRINT_ERROR("nanoGetLightfv",print_GetLightfv);
PRINT_ERROR("nanoGetLightiv",print_GetLightiv);
PRINT_ERROR("nanoGetMapdv",print_GetMapdv);
PRINT_ERROR("nanoGetMapfv",print_GetMapfv);
PRINT_ERROR("nanoGetMapiv",print_GetMapiv);
PRINT_ERROR("nanoGetMaterialfv",print_GetMaterialfv);
PRINT_ERROR("nanoGetMaterialiv",print_GetMaterialiv);
PRINT_ERROR("nanoGetPixelMapfv",print_GetPixelMapfv);
PRINT_ERROR("nanoGetPixelMapuiv",print_GetPixelMapuiv);
PRINT_ERROR("nanoGetPixelMapusv",print_GetPixelMapusv);
PRINT_ERROR("nanoGetPointerv",print_GetPointerv);
PRINT_ERROR("nanoGetPolygonStipple",print_GetPolygonStipple);
PRINT_ERROR("nanoGetString",print_GetString);
PRINT_ERROR("nanoGetTexEnvfv",print_GetTexEnvfv);
PRINT_ERROR("nanoGetTexEnviv",print_GetTexEnviv);
PRINT_ERROR("nanoGetTexGendv",print_GetTexGendv);
PRINT_ERROR("nanoGetTexGenfv",print_GetTexGenfv);
PRINT_ERROR("nanoGetTexGeniv",print_GetTexGeniv);
PRINT_ERROR("nanoGetTexImage",print_GetTexImage);
PRINT_ERROR("nanoGetTexLevelParameterfv",print_GetTexLevelParameterfv);
PRINT_ERROR("nanoGetTexLevelParameteriv",print_GetTexLevelParameteriv);
PRINT_ERROR("nanoGetTexParameterfv",print_GetTexParameterfv);
PRINT_ERROR("nanoGetTexParameteriv",print_GetTexParameteriv);
PRINT_ERROR("nanoHint",print_Hint);
PRINT_ERROR("nanoIndexMask",print_IndexMask);
PRINT_ERROR("nanoIndexPointer",print_IndexPointer);
PRINT_ERROR("nanoIndexd",print_Indexd);
PRINT_ERROR("nanoIndexdv",print_Indexdv);
PRINT_ERROR("nanoIndexf",print_Indexf);
PRINT_ERROR("nanoIndexfv",print_Indexfv);
PRINT_ERROR("nanoIndexi",print_Indexi);
PRINT_ERROR("nanoIndexiv",print_Indexiv);
PRINT_ERROR("nanoIndexs",print_Indexs);
PRINT_ERROR("nanoIndexsv",print_Indexsv);
PRINT_ERROR("nanoIndexub",print_Indexub);
PRINT_ERROR("nanoIndexubv",print_Indexubv);
PRINT_ERROR("nanoInitNames",print_InitNames);
PRINT_ERROR("nanoInterleavedArrays",print_InterleavedArrays);
PRINT_ERROR("nanoIsEnabled",print_IsEnabled);
PRINT_ERROR("nanoIsList",print_IsList);
PRINT_ERROR("nanoIsTexture",print_IsTexture);
PRINT_ERROR("nanoLightModelf",print_LightModelf);
PRINT_ERROR("nanoLightModelfv",print_LightModelfv);
PRINT_ERROR("nanoLightModeli",print_LightModeli);
PRINT_ERROR("nanoLightModeliv",print_LightModeliv);
PRINT_ERROR("nanoLightf",print_Lightf);
PRINT_ERROR("nanoLightfv",print_Lightfv);
PRINT_ERROR("nanoLighti",print_Lighti);
PRINT_ERROR("nanoLightiv",print_Lightiv);
PRINT_ERROR("nanoLineStipple",print_LineStipple);
PRINT_ERROR("nanoLineWidth",print_LineWidth);
PRINT_ERROR("nanoListBase",print_ListBase);
PRINT_ERROR("nanoLoadIdentity",print_LoadIdentity);
PRINT_ERROR("nanoLoadMatrixd",print_LoadMatrixd);
PRINT_ERROR("nanoLoadMatrixf",print_LoadMatrixf);
PRINT_ERROR("nanoLoadName",print_LoadName);
PRINT_ERROR("nanoLogicOp",print_LogicOp);
PRINT_ERROR("nanoMap1d",print_Map1d);
PRINT_ERROR("nanoMap1f",print_Map1f);
PRINT_ERROR("nanoMap2d",print_Map2d);
PRINT_ERROR("nanoMap2f",print_Map2f);
PRINT_ERROR("nanoMapGrid1d",print_MapGrid1d);
PRINT_ERROR("nanoMapGrid1f",print_MapGrid1f);
PRINT_ERROR("nanoMapGrid2d",print_MapGrid2d);
PRINT_ERROR("nanoMapGrid2f",print_MapGrid2f);
PRINT_ERROR("nanoMaterialf",print_Materialf);
PRINT_ERROR("nanoMaterialfv",print_Materialfv);
PRINT_ERROR("nanoMateriali",print_Materiali);
PRINT_ERROR("nanoMaterialiv",print_Materialiv);
PRINT_ERROR("nanoMatrixMode",print_MatrixMode);
PRINT_ERROR("nanoMultMatrixd",print_MultMatrixd);
PRINT_ERROR("nanoMultMatrixf",print_MultMatrixf);
PRINT_ERROR("nanoNewList",print_NewList);
PRINT_ERROR("nanoNormal3b",print_Normal3b);
PRINT_ERROR("nanoNormal3bv",print_Normal3bv);
PRINT_ERROR("nanoNormal3d",print_Normal3d);
PRINT_ERROR("nanoNormal3dv",print_Normal3dv);
PRINT_ERROR("nanoNormal3f",print_Normal3f);
PRINT_ERROR("nanoNormal3fv",print_Normal3fv);
PRINT_ERROR("nanoNormal3i",print_Normal3i);
PRINT_ERROR("nanoNormal3iv",print_Normal3iv);
PRINT_ERROR("nanoNormal3s",print_Normal3s);
PRINT_ERROR("nanoNormal3sv",print_Normal3sv);
PRINT_ERROR("nanoNormalPointer",print_NormalPointer);
PRINT_ERROR("nanoOrtho",print_Ortho);
PRINT_ERROR("nanoPassThrough",print_PassThrough);
PRINT_ERROR("nanoPixelMapfv",print_PixelMapfv);
PRINT_ERROR("nanoPixelMapuiv",print_PixelMapuiv);
PRINT_ERROR("nanoPixelMapusv",print_PixelMapusv);
PRINT_ERROR("nanoPixelStoref",print_PixelStoref);
PRINT_ERROR("nanoPixelStorei",print_PixelStorei);
PRINT_ERROR("nanoPixelTransferf",print_PixelTransferf);
PRINT_ERROR("nanoPixelTransferi",print_PixelTransferi);
PRINT_ERROR("nanoPixelZoom",print_PixelZoom);
PRINT_ERROR("nanoPointSize",print_PointSize);
PRINT_ERROR("nanoPolygonMode",print_PolygonMode);
PRINT_ERROR("nanoPolygonOffset",print_PolygonOffset);
PRINT_ERROR("nanoPolygonStipple",print_PolygonStipple);
PRINT_ERROR("nanoPopAttrib",print_PopAttrib);
PRINT_ERROR("nanoPopClientAttrib",print_PopClientAttrib);
PRINT_ERROR("nanoPopMatrix",print_PopMatrix);
PRINT_ERROR("nanoPopName",print_PopName);
PRINT_ERROR("nanoPrioritizeTextures",print_PrioritizeTextures);
PRINT_ERROR("nanoPushAttrib",print_PushAttrib);
PRINT_ERROR("nanoPushClientAttrib",print_PushClientAttrib);
PRINT_ERROR("nanoPushMatrix",print_PushMatrix);
PRINT_ERROR("nanoPushName",print_PushName);
PRINT_ERROR("nanoRasterPos2d",print_RasterPos2d);
PRINT_ERROR("nanoRasterPos2dv",print_RasterPos2dv);
PRINT_ERROR("nanoRasterPos2f",print_RasterPos2f);
PRINT_ERROR("nanoRasterPos2fv",print_RasterPos2fv);
PRINT_ERROR("nanoRasterPos2i",print_RasterPos2i);
PRINT_ERROR("nanoRasterPos2iv",print_RasterPos2iv);
PRINT_ERROR("nanoRasterPos2s",print_RasterPos2s);
PRINT_ERROR("nanoRasterPos2sv",print_RasterPos2sv);
PRINT_ERROR("nanoRasterPos3d",print_RasterPos3d);
PRINT_ERROR("nanoRasterPos3dv",print_RasterPos3dv);
PRINT_ERROR("nanoRasterPos3f",print_RasterPos3f);
PRINT_ERROR("nanoRasterPos3fv",print_RasterPos3fv);
PRINT_ERROR("nanoRasterPos3i",print_RasterPos3i);
PRINT_ERROR("nanoRasterPos3iv",print_RasterPos3iv);
PRINT_ERROR("nanoRasterPos3s",print_RasterPos3s);
PRINT_ERROR("nanoRasterPos3sv",print_RasterPos3sv);
PRINT_ERROR("nanoRasterPos4d",print_RasterPos4d);
PRINT_ERROR("nanoRasterPos4dv",print_RasterPos4dv);
PRINT_ERROR("nanoRasterPos4f",print_RasterPos4f);
PRINT_ERROR("nanoRasterPos4fv",print_RasterPos4fv);
PRINT_ERROR("nanoRasterPos4i",print_RasterPos4i);
PRINT_ERROR("nanoRasterPos4iv",print_RasterPos4iv);
PRINT_ERROR("nanoRasterPos4s",print_RasterPos4s);
PRINT_ERROR("nanoRasterPos4sv",print_RasterPos4sv);
PRINT_ERROR("nanoReadBuffer",print_ReadBuffer);
PRINT_ERROR("nanoReadPixels",print_ReadPixels);
PRINT_ERROR("nanoRectd",print_Rectd);
PRINT_ERROR("nanoRectdv",print_Rectdv);
PRINT_ERROR("nanoRectf",print_Rectf);
PRINT_ERROR("nanoRectfv",print_Rectfv);
PRINT_ERROR("nanoRecti",print_Recti);
PRINT_ERROR("nanoRectiv",print_Rectiv);
PRINT_ERROR("nanoRects",print_Rects);
PRINT_ERROR("nanoRectsv",print_Rectsv);
PRINT_ERROR("nanoRenderMode",print_RenderMode);
PRINT_ERROR("nanoRotated",print_Rotated);
PRINT_ERROR("nanoRotatef",print_Rotatef);
PRINT_ERROR("nanoScaled",print_Scaled);
PRINT_ERROR("nanoScalef",print_Scalef);
PRINT_ERROR("nanoScissor",print_Scissor);
PRINT_ERROR("nanoSelectBuffer",print_SelectBuffer);
PRINT_ERROR("nanoShadeModel",print_ShadeModel);
PRINT_ERROR("nanoStencilFunc",print_StencilFunc);
PRINT_ERROR("nanoStencilMask",print_StencilMask);
PRINT_ERROR("nanoStencilOp",print_StencilOp);
PRINT_ERROR("nanoTexCoord1d",print_TexCoord1d);
PRINT_ERROR("nanoTexCoord1dv",print_TexCoord1dv);
PRINT_ERROR("nanoTexCoord1f",print_TexCoord1f);
PRINT_ERROR("nanoTexCoord1fv",print_TexCoord1fv);
PRINT_ERROR("nanoTexCoord1i",print_TexCoord1i);
PRINT_ERROR("nanoTexCoord1iv",print_TexCoord1iv);
PRINT_ERROR("nanoTexCoord1s",print_TexCoord1s);
PRINT_ERROR("nanoTexCoord1sv",print_TexCoord1sv);
PRINT_ERROR("nanoTexCoord2d",print_TexCoord2d);
PRINT_ERROR("nanoTexCoord2dv",print_TexCoord2dv);
PRINT_ERROR("nanoTexCoord2f",print_TexCoord2f);
PRINT_ERROR("nanoTexCoord2fv",print_TexCoord2fv);
PRINT_ERROR("nanoTexCoord2i",print_TexCoord2i);
PRINT_ERROR("nanoTexCoord2iv",print_TexCoord2iv);
PRINT_ERROR("nanoTexCoord2s",print_TexCoord2s);
PRINT_ERROR("nanoTexCoord2sv",print_TexCoord2sv);
PRINT_ERROR("nanoTexCoord3d",print_TexCoord3d);
PRINT_ERROR("nanoTexCoord3dv",print_TexCoord3dv);
PRINT_ERROR("nanoTexCoord3f",print_TexCoord3f);
PRINT_ERROR("nanoTexCoord3fv",print_TexCoord3fv);
PRINT_ERROR("nanoTexCoord3i",print_TexCoord3i);
PRINT_ERROR("nanoTexCoord3iv",print_TexCoord3iv);
PRINT_ERROR("nanoTexCoord3s",print_TexCoord3s);
PRINT_ERROR("nanoTexCoord3sv",print_TexCoord3sv);
PRINT_ERROR("nanoTexCoord4d",print_TexCoord4d);
PRINT_ERROR("nanoTexCoord4dv",print_TexCoord4dv);
PRINT_ERROR("nanoTexCoord4f",print_TexCoord4f);
PRINT_ERROR("nanoTexCoord4fv",print_TexCoord4fv);
PRINT_ERROR("nanoTexCoord4i",print_TexCoord4i);
PRINT_ERROR("nanoTexCoord4iv",print_TexCoord4iv);
PRINT_ERROR("nanoTexCoord4s",print_TexCoord4s);
PRINT_ERROR("nanoTexCoord4sv",print_TexCoord4sv);
PRINT_ERROR("nanoTexCoordPointer",print_TexCoordPointer);
PRINT_ERROR("nanoTexEnvf",print_TexEnvf);
PRINT_ERROR("nanoTexEnvfv",print_TexEnvfv);
PRINT_ERROR("nanoTexEnvi",print_TexEnvi);
PRINT_ERROR("nanoTexEnviv",print_TexEnviv);
PRINT_ERROR("nanoTexGend",print_TexGend);
PRINT_ERROR("nanoTexGendv",print_TexGendv);
PRINT_ERROR("nanoTexGenf",print_TexGenf);
PRINT_ERROR("nanoTexGenfv",print_TexGenfv);
PRINT_ERROR("nanoTexGeni",print_TexGeni);
PRINT_ERROR("nanoTexGeniv",print_TexGeniv);
PRINT_ERROR("nanoTexImage1D",print_TexImage1D);
PRINT_ERROR("nanoTexImage2D",print_TexImage2D);
PRINT_ERROR("nanoTexParameterf",print_TexParameterf);
PRINT_ERROR("nanoTexParameterfv",print_TexParameterfv);
PRINT_ERROR("nanoTexParameteri",print_TexParameteri);
PRINT_ERROR("nanoTexParameteriv",print_TexParameteriv);
PRINT_ERROR("nanoTexSubImage1D",print_TexSubImage1D);
PRINT_ERROR("nanoTexSubImage2D",print_TexSubImage2D);
PRINT_ERROR("nanoTranslated",print_Translated);
PRINT_ERROR("nanoTranslatef",print_Translatef);
PRINT_ERROR("nanoVertex2d",print_Vertex2d);
PRINT_ERROR("nanoVertex2dv",print_Vertex2dv);
PRINT_ERROR("nanoVertex2f",print_Vertex2f);
PRINT_ERROR("nanoVertex2fv",print_Vertex2fv);
PRINT_ERROR("nanoVertex2i",print_Vertex2i);
PRINT_ERROR("nanoVertex2iv",print_Vertex2iv);
PRINT_ERROR("nanoVertex2s",print_Vertex2s);
PRINT_ERROR("nanoVertex2sv",print_Vertex2sv);
PRINT_ERROR("nanoVertex3d",print_Vertex3d);
PRINT_ERROR("nanoVertex3dv",print_Vertex3dv);
PRINT_ERROR("nanoVertex3f",print_Vertex3f);
PRINT_ERROR("nanoVertex3fv",print_Vertex3fv);
PRINT_ERROR("nanoVertex3i",print_Vertex3i);
PRINT_ERROR("nanoVertex3iv",print_Vertex3iv);
PRINT_ERROR("nanoVertex3s",print_Vertex3s);
PRINT_ERROR("nanoVertex3sv",print_Vertex3sv);
PRINT_ERROR("nanoVertex4d",print_Vertex4d);
PRINT_ERROR("nanoVertex4dv",print_Vertex4dv);
PRINT_ERROR("nanoVertex4f",print_Vertex4f);
PRINT_ERROR("nanoVertex4fv",print_Vertex4fv);
PRINT_ERROR("nanoVertex4i",print_Vertex4i);
PRINT_ERROR("nanoVertex4iv",print_Vertex4iv);
PRINT_ERROR("nanoVertex4s",print_Vertex4s);
PRINT_ERROR("nanoVertex4sv",print_Vertex4sv);
PRINT_ERROR("nanoVertexPointer",print_VertexPointer);
PRINT_ERROR("nanoViewport",print_Viewport);
...
qboolean QGL_Init( const char *dllname )
{
	...
	qglMTexCoord2fSGIS = nanoglMultiTexCoord2fARB;
	qglActiveTextureARB = nanoglActiveTexture;
	qglClientActiveTextureARB = nanoglClientActiveTexture;
