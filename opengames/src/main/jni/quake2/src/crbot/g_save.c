...
//== crbot cvars
cvar_t  *bot_skin = NULL;
cvar_t  *bot_model = NULL;
cvar_t  *bot_team = NULL;
cvar_t  *bot_skill = NULL;

cvar_t  *bot_menu = NULL;

cvar_t  *bot_chat = NULL;
cvar_t  *obituary_msgs = NULL;
cvar_t  *bot_taunt = NULL;
cvar_t  *map_cycle = NULL;

cvar_t  *game_path = NULL;
cvar_t  *base_path = NULL;
cvar_t  *no_tech = NULL;
cvar_t  *no_hook = NULL;
