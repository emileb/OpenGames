...
void R_SetupGL (void)
{
	...
	//qglViewport (x, y2, 640, 480);
	qglViewport (0, 0, android_screen_width, android_screen_height);
	//
...
void R_Register( void )
{
	...
	gl_modulate = ri.Cvar_Get ("gl_modulate", "4", CVAR_ARCHIVE );
	...
	gl_dynamic = ri.Cvar_Get ("gl_dynamic", "0", CVAR_ARCHIVE);
	...
	gl_3dlabs_broken = ri.Cvar_Get( "gl_3dlabs_broken", "0", CVAR_ARCHIVE );
