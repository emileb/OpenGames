...
#if !defined(CC_GUARD_CC_ROGUE_HEATBEAM_H) || !INCLUDE_GUARDS
#define CC_GUARD_CC_ROGUE_HEATBEAM_H

class CHeatBeamWeapon : public IWeaponBase
{
public:
	CHeatBeamWeapon();
	...
	WEAPON_CLASS_DEFS (CHeatBeamWeapon);
};
