...
//
// cc_xatrix_soldier_hyper.h
// 
//

#if !defined(CC_GUARD_CC_XATRIX_SOLDIER_HYPER_H) || !INCLUDE_GUARDS
#define CC_GUARD_CC_XATRIX_SOLDIER_HYPER_H

class CSoldierHyper : public CSoldierBase
{
public:
...
public:
	...
	CBlueBlasterProjectile ();
	CBlueBlasterProjectile (sint32 Index);

	IMPLEMENT_SAVE_HEADER (CBlueBlasterProjectile)
