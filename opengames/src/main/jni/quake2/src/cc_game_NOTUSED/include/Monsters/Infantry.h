...
#if !defined(CC_GUARD_INFANTRY_H) || !INCLUDE_GUARDS
#define CC_GUARD_INFANTRY_H

class CInfantry : public IMonster
{
public:
	enum
	{
	...
	virtual inline const char	*GetMonsterName() { return "Infantry"; }
