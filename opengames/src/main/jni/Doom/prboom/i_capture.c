...
void I_CapturePrep (const char *fn)
{
  ...
  soundpipe.outthread = SDL_CreateThread (threadstdoutproc, "prboom",&soundpipe);
  soundpipe.errthread = SDL_CreateThread (threadstderrproc,  "prboom",&soundpipe);
  videopipe.stdoutdumpname = "video_stdout.txt";
  videopipe.stderrdumpname = "video_stderr.txt";
  videopipe.outthread = SDL_CreateThread (threadstdoutproc, "prboom", &videopipe);
  videopipe.errthread = SDL_CreateThread (threadstderrproc, "prboom", &videopipe);
...
void I_CaptureFinish (void)
{
  ...
  muxpipe.outthread = SDL_CreateThread (threadstdoutproc, "prboom", &muxpipe);
  muxpipe.errthread = SDL_CreateThread (threadstderrproc, "prboom", &muxpipe);
