...
//#endif
...
#endif
  {"snd_soundfont",{NULL, &snd_soundfont},{0,"/sdcard/TimGM6mb.sf2"},UL,UL,def_str,ss_none}, // soundfont name for synths that support it
  ...
  {"gl_ext_texture_filter_anisotropic", {&gl_ext_texture_filter_anisotropic_default}, {1},0,1,
   def_bool,ss_stat},
  {"gl_use_stencil", {&gl_use_stencil_default}, {0},0,1,
   def_bool,ss_stat},
  {"gl_use_display_lists",{&gl_use_display_lists},{0},0,1,
   def_bool,ss_none},

  {"gl_vsync",{&gl_vsync},{0},0,1,
   def_bool,ss_none},
...
// CPhipps - now they're the doom codes, so default.cfg can be portable
  ...
  {"map_overlay_pos_height", {&map_overlay_pos_height}, {200},0,200,
   def_int,ss_auto},
  {"map_things_appearance", {(int*)&map_things_appearance}, {0},0,map_things_appearance_max-1,
   def_int,ss_auto},
...
//e6y
  ...
  {"render_stretch_hud", {&render_stretch_hud_default},{patch_stretch_full},0,patch_stretch_max - 1,
  def_int,ss_stat},
