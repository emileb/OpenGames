...
LOCAL_C_INCLUDES :=  $(TOP_DIR)/SDL/include $(TOP_DIR)/SDL_net/include $(TOP_DIR)/SDL_mixer $(TOP_DIR)/SDL_image $(TOP_DIR)/openal/include $(TOP_DIR)/libpng $(TOP_DIR)/jpeg8d $(TOP_DIR)/TouchControls  $(TOP_DIR)/TinyXML $(TOP_DIR)/ 
...
android-jni.cpp in_android.c \
 ...
 i_smp.c        i_smp.h   gl_map.c d_server.c
...
LOCAL_STATIC_LIBRARIES :=  nanogl pcsound  prboomsdl doommusic textscreen SDL_net libjpeg
