...
static void SaveDefaultCollection(default_collection_t *collection)
{
    ...
    fflush(f); //Needed for Android, should be ok on other platforms
...
#ifdef __ANDROID__ //Force some keys for Android
    extern int key_menu_confirm,key_prevweapon,key_nextweapon;
