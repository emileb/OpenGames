...
LOCAL_STATIC_LIBRARIES := s-setup nanogl fluidsynth-static SDL_net libjpeg lzma gdtoa dumb gme bzip2
LOCAL_SHARED_LIBRARIES := touchcontrols output_sdl fmod openal SDL
#fmod
